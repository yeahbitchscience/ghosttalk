...
export default function BottomNav() {
  ...
  return (
    <div className="absolute bottom-0 w-full bg-ghost-panel/95 backdrop-blur-xl border-t border-ghost-border flex justify-around items-center h-[72px] z-50 pb-safe">
